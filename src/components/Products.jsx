  ...
  const featuredProducts = [
    {
      ...
      image: '/images/product-sandaufbereitungsanlage.png',
    ...
    },
    {
      ...
      image: '/images/product-doppelspiralfoerderer.png',
      icon: <Factory size={32} />,
    },
    {
      ...
      image: '/images/product-schlammtrockner.png',
      icon: <Factory size={32} />,
    },
    {
      ...
      image: '/images/product-spiralfoerderer.png',
      icon: <Factory size={32} />,
    },
    {
      ...
      image: '/images/product-wendelbrecher-1.png',
      icon: <Cog size={32} />,
    },
    {
      ...
      image: '/images/product-motorkonsole.png',
      icon: <Cog size={32} />,
    },
    {
      ...
      image: '/images/product-schweisskonstruktionen.png',
      icon: <Wrench size={32} />,
    },
    {
      ...
      image: '/images/product-plasmabrennbecken.png',
      icon: <Wrench size={32} />,
    },
    {
      ...
      image: '/images/product-abkantarbeiten.png',
      icon: <Wrench size={32} />,
    },
    {
      ...
      image: '/images/product-diffusor.png',
    ...
    },
    {
      ...
      image: '/images/product-schmelztiegel.png',
      icon: <Sparkles size={32} />,
    },
    {
      ...
      image: '/images/product-siebtrommel.png',
      icon: <Sparkles size={32} />,
    },
    {
      ...
      image: '/images/product-unterbau.png',
      icon: <Wrench size={32} />,
    },
  ];
